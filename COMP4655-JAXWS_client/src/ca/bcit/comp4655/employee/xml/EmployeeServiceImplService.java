 ...
 * 
 */
@WebServiceClient(name = "EmployeeServiceImplService", targetNamespace = "http://xml.employee.comp4655.bcit.ca/", wsdlLocation = "http://localhost:8181/employeeServices?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICEIMPLSERVICE_QNAME = new QName("http://xml.employee.comp4655.bcit.ca/", "EmployeeServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8181/employeeServices?wsdl");
    ...
    public EmployeeServicePort getEmployeeServiceImplPort() {
        return super.getPort(new QName("http://xml.employee.comp4655.bcit.ca/", "EmployeeServiceImplPort"), EmployeeServicePort.class);
    }
     ...
     */
    @WebEndpoint(name = "EmployeeServiceImplPort")
    public EmployeeServicePort getEmployeeServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://xml.employee.comp4655.bcit.ca/", "EmployeeServiceImplPort"), EmployeeServicePort.class, features);
    }
