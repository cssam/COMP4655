 ...
 * 
 */
@WebServiceClient(name = "EmployeeServiceImplService", targetNamespace = "http://impl.comp4655.bcit.ca/", wsdlLocation = "http://localhost:8181/employeeServices?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICEIMPLSERVICE_QNAME = new QName("http://impl.comp4655.bcit.ca/", "EmployeeServiceImplService");
    ...
    public EmployeeServicePort getEmployeeServiceImplPort() {
        return super.getPort(new QName("http://impl.comp4655.bcit.ca/", "EmployeeServiceImplPort"), EmployeeServicePort.class);
    }
    ...
    public EmployeeServicePort getEmployeeServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.comp4655.bcit.ca/", "EmployeeServiceImplPort"), EmployeeServicePort.class, features);
    }
