...
import ca.bcit.comp4655.employee.ejb.EmployeeServiceRemote;
...
//	private static final String COMMANDS_FILE = "/data/commands.properties";
	...
	@EJB( mappedName="EmployeeServiceBean", beanInterface=EmployeeServiceRemote.class)
	...
	public void init() throws ServletException 
	{
		...
		try 
		{
			...
			//service = (EmployeeService) context.lookup( "EmployeeServiceBean" );
