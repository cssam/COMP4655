 ...
 * 
 */
@WebServiceClient(name = "EmployeeService", targetNamespace = "http://www.bcit.ca/comp4655/employee/xml", wsdlLocation = "file:/Users/chandima/Google%20Drive/JavaProjectServ/A00558231_JAXWS_server/src/Employee.wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICE_QNAME = new QName("http://www.bcit.ca/comp4655/employee/xml", "EmployeeService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/Users/chandima/Google%20Drive/JavaProjectServ/A00558231_JAXWS_server/src/Employee.wsdl");
    ...
    public EmployeeServicePort getEmployeeServicePort() {
        return super.getPort(new QName("http://www.bcit.ca/comp4655/employee/xml", "EmployeeServicePort"), EmployeeServicePort.class);
    }
    ...
    public EmployeeServicePort getEmployeeServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.bcit.ca/comp4655/employee/xml", "EmployeeServicePort"), EmployeeServicePort.class, features);
    }
