package ca.bcit.comp4655.employee.producer.synch;
...
public class EmployeeServer
{
	...
	public EmployeeServer() throws NamingException, JMSException
	{
		ConnectionUtil request = new ConnectionUtil( getConnectionElemenets( "queue/employeeRequest" ) );
		...
		while ( true )
		{
			 ...
			 if ( message !=null )
			 {
				 ...
				 ConnectionUtil response = new ConnectionUtil( getConnectionElemenets( "queue/employeeResponse" ) );
